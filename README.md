...
* **bower:**
`bower install https://npmcdn.com/react-selectize@0.7.3/bower.zip`
...
<html>
 <head>
  ...
  <!-- REACT SELECTIZE -->
  <script src="https://npmcdn.com/react-selectize@0.7.3/dist/index.min.js" type="text/javascript" ></script>

  <!-- THEMES (default, bootstrap3, material) -->
  <link rel="stylesheet" href="https://npmcdn.com/react-selectize@0.7.3/dist/index.min.css"/>
