...
- [Changelog](CHANGELOG.md) (last updated on 10th February 2016)
...
* **bower:**
`bower install https://npmcdn.com/react-selectize@0.7.4/bower.zip`
...
<html>
 <head>
  ...
  <!-- REACT SELECTIZE -->
  <script src="https://npmcdn.com/react-selectize@0.7.4/dist/index.min.js" type="text/javascript" ></script>

  <!-- THEMES (default, bootstrap3, material) -->
  <link rel="stylesheet" href="https://npmcdn.com/react-selectize@0.7.4/dist/index.min.css"/>
