...
- [Changelog](CHANGELOG.md) (last updated on 19th February 2016)
...
* **bower:**
`bower install https://npmcdn.com/react-selectize@0.8.1/bower.zip`
...
<html>
 <head>
  ...
  <!-- REACT SELECTIZE -->
  <script src="https://npmcdn.com/react-selectize@0.8.1/dist/index.min.js" type="text/javascript" ></script>

  <!-- THEMES (default, bootstrap3, material) -->
  <link rel="stylesheet" href="https://npmcdn.com/react-selectize@0.8.1/dist/index.min.css"/>
