...
* **bower:**
`bower install https://npmcdn.com/react-selectize@0.7.1/bower.zip`
...
<html>
 <head>
  ...
  <script src="https://npmcdn.com/react-selectize@0.7.1/dist/index.min.js" type="text/javascript" ></script>

  <!-- built in themes (default, bootstrap3, material) -->
  <link rel="stylesheet" href="https://npmcdn.com/react-selectize@0.7.1/dist/index.min.css"/>
 </head>
</html>
```
